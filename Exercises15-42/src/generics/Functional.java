...
public class Functional {
    ...
    //object may act as collecting parameter , so it is
    //returned at the end
    ...
    public static void main(String[] args) {
        ...
        System.out.println(filter(li,new GreaterThan<>(4))); //[5, 6, 7]
        //5040
        ...
        System.out.println(forEach(filter(li,new GreaterThan<>(4)),
                new MultiplyingIntegerCollector()).result());//210
        ...
        System.out.println(rbd); //11.000000
        //[3.300000, 4.400000]
        ...
        System.out.println(transform(lbd,new BigDecimalUlp()));//[0.000001, 0.000001, 0.000001, 0.000001]
    }
